# Deploy Odoo on your server in one click


## Quick Installation

Install [docker](https://docs.docker.com/get-docker/) yourself, then run the following to set up first Odoo instance @ `localhost:10016` (default master password: `minhng.info`):
